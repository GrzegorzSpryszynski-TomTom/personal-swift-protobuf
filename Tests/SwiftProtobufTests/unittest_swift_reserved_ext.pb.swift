...
let UnittestSwiftReservedExt_Extensions: GSSwiftProtobuf.SimpleExtensionMap = [
...
/// Will get _p added because it has no package/swift prefix to scope and
/// would otherwise be a problem when added to the message.
let Extensions_debugDescription = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1000,
  fieldName: "debugDescription"
)

/// These will get _p added for the same reasoning.
let Extensions_as = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1012,
  fieldName: "as"
)

let Extensions_var = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1013,
  fieldName: "var"
)

let Extensions_try = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1014,
  fieldName: "try"
)

let Extensions_do = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1015,
  fieldName: "do"
)

let Extensions_nil = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
...
extension SwiftReservedTestExt2 {
  enum Extensions {
    static let hashValue_ = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
    ...
    /// Reserved words, since these end up in the "enum Extensions", they
    /// can't just be get their names, and sanitation kicks.
    static let `as` = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1022,
      fieldName: "SwiftReservedTestExt2.as"
    )

    static let `var` = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1023,
      fieldName: "SwiftReservedTestExt2.var"
    )

    static let `try` = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1024,
      fieldName: "SwiftReservedTestExt2.try"
    )

    static let `do` = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1025,
      fieldName: "SwiftReservedTestExt2.do"
    )

    static let `nil` = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
...
extension SwiftReservedTestExt2: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
