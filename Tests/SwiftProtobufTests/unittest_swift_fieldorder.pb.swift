...
struct Swift_Protobuf_TestFieldOrderings: GSSwiftProtobuf.ExtensibleMessage {
...
struct Swift_Protobuf_OneofTraversalGeneration: GSSwiftProtobuf.ExtensibleMessage {
  // GSSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let Swift_Protobuf_UnittestSwiftFieldorder_Extensions: GSSwiftProtobuf.SimpleExtensionMap = [
...
let Swift_Protobuf_Extensions_my_extension_string = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufString>, Swift_Protobuf_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "swift.protobuf.my_extension_string"
)

let Swift_Protobuf_Extensions_my_extension_int = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufInt32>, Swift_Protobuf_TestFieldOrderings>(
...
extension Swift_Protobuf_TestFieldOrderings: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_TestFieldOrderings.NestedMessage: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_OneofTraversalGeneration: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
