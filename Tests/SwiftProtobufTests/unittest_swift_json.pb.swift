...
struct ProtobufUnittest_SwiftJSONTest {
  ...
  var repeatedNullValue: [TTSwiftProtobuf.Google_Protobuf_NullValue] = []
...
extension ProtobufUnittest_SwiftJSONTest: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
