...
let Ext4UnittestSwiftExtension4_Extensions: TTSwiftProtobuf.SimpleExtensionMap = [
  Ext4Extensions_b,
  Ext4Extensions_C,
...
let Ext4Extensions_b = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalExtensionField<TTSwiftProtobuf.ProtobufString>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
  _protobuf_fieldNumber: 420,
  fieldName: "protobuf_unittest.extend4.b"
)

let Ext4Extensions_C = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalGroupExtensionField<Ext4C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension Ext4MyMessage {
  enum Extensions {
    ...
    static let C = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalGroupExtensionField<Ext4MyMessage.C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension Ext4MyMessage: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension Ext4MyMessage.C: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension Ext4C: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
