...
let Ext4UnittestSwiftExtension4_Extensions: GSSwiftProtobuf.SimpleExtensionMap = [
  Ext4Extensions_b,
  Ext4Extensions_C,
...
let Ext4Extensions_b = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalExtensionField<GSSwiftProtobuf.ProtobufString>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
  _protobuf_fieldNumber: 420,
  fieldName: "protobuf_unittest.extend4.b"
)

let Ext4Extensions_C = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalGroupExtensionField<Ext4C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension Ext4MyMessage {
  enum Extensions {
    ...
    static let C = GSSwiftProtobuf.MessageExtension<GSSwiftProtobuf.OptionalGroupExtensionField<Ext4MyMessage.C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension Ext4MyMessage: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
...
extension Ext4MyMessage.C: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
...
extension Ext4C: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
