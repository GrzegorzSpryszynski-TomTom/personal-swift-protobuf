...
struct Google_Protobuf_Compiler_CodeGeneratorRequest {
  ...
  /// fully qualified.
  var protoFile: [TTSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  var sourceFileDescriptors: [TTSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []
...
struct Google_Protobuf_Compiler_CodeGeneratorResponse {
  ...
  enum Feature: TTSwiftProtobuf.Enum {
  ...
  struct File {
    ...
    var generatedCodeInfo: TTSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo {
