...
struct Swift_Protobuf_TestFieldOrderings: TTSwiftProtobuf.ExtensibleMessage {
...
struct Swift_Protobuf_OneofTraversalGeneration: TTSwiftProtobuf.ExtensibleMessage {
  // TTSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let Swift_Protobuf_UnittestSwiftFieldorder_Extensions: TTSwiftProtobuf.SimpleExtensionMap = [
...
let Swift_Protobuf_Extensions_my_extension_string = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalExtensionField<TTSwiftProtobuf.ProtobufString>, Swift_Protobuf_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "swift.protobuf.my_extension_string"
)

let Swift_Protobuf_Extensions_my_extension_int = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalExtensionField<TTSwiftProtobuf.ProtobufInt32>, Swift_Protobuf_TestFieldOrderings>(
...
extension Swift_Protobuf_TestFieldOrderings: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_TestFieldOrderings.NestedMessage: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_OneofTraversalGeneration: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
