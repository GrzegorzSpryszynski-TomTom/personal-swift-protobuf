...
let ProtobufUnittest_Extend3_UnittestSwiftExtension3_Extensions: TTSwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufUnittest_Extend3_Extensions_b = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalExtensionField<TTSwiftProtobuf.ProtobufString>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
  _protobuf_fieldNumber: 320,
  fieldName: "protobuf_unittest.extend3.b"
)

let ProtobufUnittest_Extend3_Extensions_C = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalGroupExtensionField<ProtobufUnittest_Extend3_C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension ProtobufUnittest_Extend3_MyMessage {
  enum Extensions {
    static let b = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalExtensionField<TTSwiftProtobuf.ProtobufString>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
      _protobuf_fieldNumber: 310,
      fieldName: "protobuf_unittest.extend3.MyMessage.b"
    )

    static let C = TTSwiftProtobuf.MessageExtension<TTSwiftProtobuf.OptionalGroupExtensionField<ProtobufUnittest_Extend3_MyMessage.C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension ProtobufUnittest_Extend3_MyMessage: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_Extend3_MyMessage.C: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_Extend3_C: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
