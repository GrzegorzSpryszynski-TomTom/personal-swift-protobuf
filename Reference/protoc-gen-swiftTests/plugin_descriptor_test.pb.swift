...
struct SwiftDescriptorTest_MsgExtensionRangeOrdering: TTSwiftProtobuf.ExtensibleMessage {
...
struct SwiftDescriptorTest_MsgExtensionRangeOrderingWithFields: TTSwiftProtobuf.ExtensibleMessage {
  // TTSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SwiftDescriptorTest_MsgExtensionRangeOrderingNoMerging: TTSwiftProtobuf.ExtensibleMessage {
  // TTSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SwiftDescriptorTest_MsgExtensionRangeOrdering: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension SwiftDescriptorTest_MsgExtensionRangeOrderingWithFields: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension SwiftDescriptorTest_MsgExtensionRangeOrderingNoMerging: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
