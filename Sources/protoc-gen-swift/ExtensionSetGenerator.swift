...
class ExtensionSetGenerator {
    ...
    func generateFileProtobufExtensionRegistry(printer p: inout CodePrinter) {
        ...
        p.print(
          ...
          "\n",
          "/// A `TTSwiftProtobuf.SimpleExtensionMap` that includes all of the extensions defined by\n",
          "/// this .proto file. It can be used any place an `TTSwiftProtobuf.ExtensionMap` is needed\n",
          "/// in parsing, or it can be combined with other `TTSwiftProtobuf.SimpleExtensionMap`s to create\n",
          "/// a larger `TTSwiftProtobuf.SimpleExtensionMap`.\n",
