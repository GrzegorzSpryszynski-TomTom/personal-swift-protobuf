...
public struct Google_Protobuf_Compiler_CodeGeneratorRequest {
  ...
  /// fully qualified.
  public var protoFile: [GSSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  public var sourceFileDescriptors: [GSSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []
...
public struct Google_Protobuf_Compiler_CodeGeneratorResponse {
  ...
  public enum Feature: GSSwiftProtobuf.Enum {
  ...
  public struct File {
    ...
    public var generatedCodeInfo: GSSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo {
      get {return _generatedCodeInfo ?? GSSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo()}
    ...
    fileprivate var _generatedCodeInfo: GSSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo? = nil
  }
...
extension Google_Protobuf_Compiler_Version: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorRequest: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    if !GSSwiftProtobuf.Internal.areAllInitialized(self.protoFile) {return false}
    if !GSSwiftProtobuf.Internal.areAllInitialized(self.sourceFileDescriptors) {return false}
    return true
  }
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.Feature: GSSwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: GSSwiftProtobuf._NameMap = [
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.File: GSSwiftProtobuf.Message, GSSwiftProtobuf._MessageImplementationBase, GSSwiftProtobuf._ProtoNameProviding {
