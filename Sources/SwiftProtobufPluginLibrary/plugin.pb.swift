...
public struct Google_Protobuf_Compiler_CodeGeneratorRequest {
  ...
  /// fully qualified.
  public var protoFile: [TTSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  public var sourceFileDescriptors: [TTSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []
...
public struct Google_Protobuf_Compiler_CodeGeneratorResponse {
  ...
  public enum Feature: TTSwiftProtobuf.Enum {
  ...
  public struct File {
    ...
    public var generatedCodeInfo: TTSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo {
      get {return _generatedCodeInfo ?? TTSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo()}
    ...
    fileprivate var _generatedCodeInfo: TTSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo? = nil
  }
...
extension Google_Protobuf_Compiler_Version: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorRequest: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    if !TTSwiftProtobuf.Internal.areAllInitialized(self.protoFile) {return false}
    if !TTSwiftProtobuf.Internal.areAllInitialized(self.sourceFileDescriptors) {return false}
    return true
  }
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.Feature: TTSwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: TTSwiftProtobuf._NameMap = [
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.File: TTSwiftProtobuf.Message, TTSwiftProtobuf._MessageImplementationBase, TTSwiftProtobuf._ProtoNameProviding {
