...
func buildResponse(serializedData: Data) -> Conformance_ConformanceResponse {
    ...
    let msgType: GSSwiftProtobuf.Message.Type
    let extensions: GSSwiftProtobuf.ExtensionMap
    ...
    case ProtobufTestMessages_Proto3_TestAllTypesProto3.protoMessageName:
        ...
        extensions = GSSwiftProtobuf.SimpleExtensionMap()
    ...
    let testMessage: GSSwiftProtobuf.Message
